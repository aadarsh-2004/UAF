      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4">
              Dedicated to improving the lives of stray animals in Udaipur
              through food, shelter, medical care, and community education.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>
                  10 Siddharth Nagar ,Inspiro building , New bhopalpura ,
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/vol" className="hover:text-white">
                  Volunteer
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-amber-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 md:mb-0">
              <a
                href="https://www.facebook.com/share/g/1A6HX9TKzA/"
                className="text-amber-50 hover:text-white"
              >
                <Facebook className="h-6 w-6" />
              </a>
              <a
                href="https://www.instagram.com/uaf_bharat/"
                className="text-amber-50 hover:text-white"
              >
            ...
            <p className="text-center md:text-right">
              &copy; {new Date().getFullYear()} Udaipur Animal Feed. All rights
              reserved.
            </p>
          </div>
        </div>
